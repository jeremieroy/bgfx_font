...
--- compile shaders for every target
function bgfx_compile_shaders(_input_dir, _runtime_dir, _build_dir )
	bgfx_compile_shader(INPUT_SHADERS_DIR, RUNTIME_DIR, BUILD_DIR, "dx9" )
	bgfx_compile_shader(INPUT_SHADERS_DIR, RUNTIME_DIR, BUILD_DIR, "dx11" )
	bgfx_compile_shader(INPUT_SHADERS_DIR, RUNTIME_DIR, BUILD_DIR, "nacl" )
	bgfx_compile_shader(INPUT_SHADERS_DIR, RUNTIME_DIR, BUILD_DIR, "android" )
	bgfx_compile_shader(INPUT_SHADERS_DIR, RUNTIME_DIR, BUILD_DIR, "linux" )
end
